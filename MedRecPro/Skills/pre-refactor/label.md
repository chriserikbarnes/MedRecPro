...
1. **FIRST TRY**: `GET /api/Label/ingredient/summaries?pageNumber=1&pageSize=200`
2. For active only: `GET /api/Label/ingredient/active/summaries?pageNumber=1&pageSize=200`
3. For inactive only: `GET /api/Label/ingredient/inactive/summaries?pageNumber=1&pageSize=200`
4. **FALLBACK**: `GET /api/label/section/ActiveIngredient?pageNumber=1&pageSize=200`
5. **ALSO**: `GET /api/label/section/InactiveIngredient?pageNumber=1&pageSize=200`
...
1. **FIRST TRY**: `GET /api/Label/labeler/summaries?pageNumber=1&pageSize=150`
2. **FALLBACK**: `GET /api/label/section/Organization?pageNumber=1&pageSize=150`
