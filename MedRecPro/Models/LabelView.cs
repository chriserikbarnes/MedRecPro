...
namespace MedRecPro.Models
{
    ...
    public class LabelView
    {
        ...
        /// from a parsed SPL table cell, with fully decomposed values and provenance.
        /// </summary>
        /// <remarks>
        /// ## Pipeline Position
        /// Stage 2 (ReconstructedTable) → Parser → ParsedObservation → Orchestrator → **tmp_FlattenedStandardizedTable**
        ///
        ...
        /// - Idempotent DDL (IF NOT EXISTS) — see Create_tmp_FlattenedStandardizedTable.sql
        /// - Truncate-on-rerun semantics via orchestrator
        /// - Keyless (no PK) — uses nonclustered indexes for query performance
        /// - Registered via ApplicationDbContext reflection on LabelView nested classes
        /// </remarks>
        /// <example>
        /// <code>
        /// var observations = await db.Set&lt;LabelView.FlattenedStandardizedTable&gt;()
        ///     .AsNoTracking()
        ///     .Where(o => o.TableCategory == "PK" &amp;&amp; o.Population == "Pediatric")
        ///     .ToListAsync();
        /// </code>
        /// </example>
        /// <seealso cref="Label"/>
        /// <seealso cref="Label.Document"/>
        [Table("tmp_FlattenedStandardizedTable")]
