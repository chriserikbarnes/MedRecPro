...
/****** Object:  View [dbo].[vw_IngredientInactiveSummary]    Script Date: 12/15/2025 11:54:21 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER VIEW [dbo].[vw_IngredientInactiveSummary]
AS
...
IF NOT EXISTS (SELECT * FROM sys.fn_listextendedproperty(N'MS_DiagramPane1' , N'SCHEMA',N'dbo', N'VIEW',N'vw_IngredientInactiveSummary', NULL,NULL))
   ...
   Begin DiagramPane = 
      ...
      Begin Tables = 
         ...
         Begin Table = "da"
            ...
            DisplayFlags = 280
            TopColumn = 0
  ' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vw_IngredientInactiveSummary'
ELSE
BEGIN
...
IF NOT EXISTS (SELECT * FROM sys.fn_listextendedproperty(N'MS_DiagramPane2' , N'SCHEMA',N'dbo', N'VIEW',N'vw_IngredientInactiveSummary', NULL,NULL))
...
IF NOT EXISTS (SELECT * FROM sys.fn_listextendedproperty(N'MS_DiagramPaneCount' , N'SCHEMA',N'dbo', N'VIEW',N'vw_IngredientInactiveSummary', NULL,NULL))
	EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=2 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vw_IngredientInactiveSummary'
ELSE
BEGIN
	EXEC sys.sp_updateextendedproperty @name=N'MS_DiagramPaneCount', @value=2 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vw_IngredientInactiveSummary'
END
GO
