/* 
     ...
     Revision: $Id: xml-verbatim.js,v 1.2 2006/12/18 19:22:59 andybs Exp $
*/
...
function xmlVerbatimUnhideElementById(id) {
    xmlVerbatimPathTo(document.getElementById(id), "expand");
    Util.resetIframeHeight();
}

function xmlVerbatimPathTo(element, mode) {
    while (element) {
        if (element.className == "xml-verbatim-element")
