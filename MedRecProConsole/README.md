...
4. **Truncation**: Optionally truncate `tmp_FlattenedStandardizedTable`, `tmp_FlattenedAdverseEventTable`, and `tmp_FlattenedAdverseEventRiskTable` before rerun.
...
| `truncate` | Wipe `tmp_FlattenedStandardizedTable`, truncate `tmp_FlattenedAdverseEventTable` and `tmp_FlattenedAdverseEventRiskTable` when registered, and remove the progress file |
