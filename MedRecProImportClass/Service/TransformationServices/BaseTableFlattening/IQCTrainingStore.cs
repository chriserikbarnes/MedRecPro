...
namespace MedRecProImportClass.Service.TransformationServices
{
    ...
    public interface IQCTrainingStore
    {
        /**************************************************************/
        /// <summary>
        ...
        /// exceeds <see cref="QCNetCorrectionSettings.MaxAccumulatorRows"/> (bootstrap records
        ...
        Task AddRecordsAsync(IEnumerable<QCTrainingRecord> records, CancellationToken ct = default);
        ...
        IReadOnlyList<QCTrainingRecord> GetRecords();

        /**************************************************************/
        /// <summary>
        /// Records that a model retrain has completed. Updates <see cref="QCTrainingStoreState.LastRetrainAt"/>
        /// and persists state.
        /// </summary>
        /// <param name="ct">Cancellation token.</param>
