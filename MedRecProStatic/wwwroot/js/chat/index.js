...
const MedRecProChat = (function () {
    ...
    const TEST_COMMANDS = Object.freeze([
        ...
        { tokens: ['api', 'all', 'fast'], kind: 'api', category: 'all-fast', profile: 'all-fast', testIds: ['phase2.seedCompleteness', 'read.label.productSearch', 'read.label.single', 'read.ae.catalog', 'read.orangeBook.expiring', 'read.ai.context'], seedTestIds: ['seed.label.productLatest'], description: 'Run the nine-request browser-health check for Settings, sign-in, Labels, the AE product picker, Orange Book, and AI context.' },
