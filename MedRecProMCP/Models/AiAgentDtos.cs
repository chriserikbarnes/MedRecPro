/**************************************************************/
/// <summary>
/// Data transfer objects for AI agent operations.
/// </summary>
/// <remarks>
/// These DTOs are adapted from MedRecPro.Models.AiAgentDtos to support
/// the MCP gateway's communication with the MedRecPro API for AI-powered
/// pharmaceutical queries. The interpret → collect → synthesize flow
/// is coordinated by the WorkPlanExecutor service.
/// </remarks>
/// <seealso cref="MedRecProMCP.Services.IWorkPlanExecutor"/>
/// <seealso cref="MedRecProMCP.Services.MedRecProApiClient"/>
/**************************************************************/
...
/// - Structured endpoint specifications for execution
...
/// </summary>
/// <remarks>
/// This specification provides everything needed to construct and
/// execute an HTTP request to the MedRecPro API. The WorkPlanExecutor
/// handles actual execution to maintain authentication context.
/// </remarks>
/// <seealso cref="AiAgentInterpretation"/>
/**************************************************************/
public class AiEndpointSpecification
{
    ...
    /// </summary>
    /// <example>/api/views/ingredient/search</example>
    /// <example>/api/labels/Document/{encryptedId}</example>
    /**************************************************************/
    ...
    /// </summary>
    /// <example>{ "substanceNameSearch": "aspirin", "pageSize": "25" }</example>
    /**************************************************************/
    ...
    /// </summary>
    /// <example>"array", "object", "file", "stream"</example>
    /**************************************************************/
    ...
    /// Can be an int or int[] for multiple dependencies.
    /// </summary>
    /**************************************************************/
    ...
    /// </summary>
    /// <remarks>
    /// Each entry in the dictionary represents an output mapping, where the key is the
    /// output name and the value is the JSONPath-like extraction pattern.
    /// </remarks>
    /**************************************************************/
    ...
    /// </example>
    /**************************************************************/
    [JsonPropertyName("skipIfPreviousHasResults")]
