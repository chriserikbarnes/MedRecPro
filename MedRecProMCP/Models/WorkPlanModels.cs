...
/**************************************************************/
/// <summary>
/// Configuration options for work plan execution.
/// </summary>
/// <remarks>
/// These settings control the behavior of the work plan executor,
/// including thresholds for checkpoints, batching sizes, and timeouts.
/// Bind to the "WorkPlan" configuration section in appsettings.json.
/// </remarks>
/// <seealso cref="MedRecProMCP.Services.WorkPlanExecutor"/>
/**************************************************************/
public class WorkPlanExecutionOptions
{
    /**************************************************************/
    /// <summary>
    /// Number of discovered products that triggers a checkpoint.
    /// When more products are found than this threshold, execution
    /// pauses for user selection.
    /// </summary>
    /// <remarks>Default: 5</remarks>
    /**************************************************************/
    public int CheckpointThreshold { get; set; } = 5;

    /**************************************************************/
    /// <summary>
    /// Maximum number of concurrent API calls during execution.
    /// </summary>
    /// <remarks>Default: 5</remarks>
    /**************************************************************/
    ...
    /// Smaller batches prevent token limit issues.
    /// </summary>
    ...
    /**************************************************************/
    public int PerCallTimeoutSeconds { get; set; } = 30;
