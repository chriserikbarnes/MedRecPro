...
namespace MedRecPro.Service.Test
{
    ...
    public class TableParsingOrchestratorStageTests
    {
        ...
        public async Task CorrectObservationsAsync_DelegatesToCorrectionService()
        {
            ...
            mockCorrection.Setup(c => c.CorrectBatchAsync(testObservations, It.IsAny<CancellationToken>()))
            ...
            mockCorrection.Verify(c => c.CorrectBatchAsync(testObservations, It.IsAny<CancellationToken>()), Times.Once);
        ...
        public async Task CorrectObservationsAsync_ReturnsOriginal_WhenListIsEmpty()
        {
            ...
            mockCorrection.Verify(c => c.CorrectBatchAsync(It.IsAny<List<ParsedObservation>>(), It.IsAny<CancellationToken>()), Times.Never);
