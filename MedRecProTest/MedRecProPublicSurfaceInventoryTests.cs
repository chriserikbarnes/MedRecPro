...
namespace MedRecPro.Service.Test
{
    ...
    public class MedRecProPublicSurfaceInventoryTests
    {
        ...
        private static readonly Dictionary<string, string> CoverageMap = new(StringComparer.Ordinal)
        {
            ...
            ["LabelSectionCrudService.GetEntityType"] = nameof(LabelControllerDecompositionServiceTests),
            ["LabelSectionCrudService.GetMenu"] = nameof(LabelControllerDecompositionServiceTests),
            ["LabelSectionCrudService.GetPrimaryKeyProperty"] = nameof(LabelControllerDecompositionServiceTests),
            ["LabelSectionCrudService.GetRepository"] = nameof(LabelControllerDecompositionServiceTests),
            ["LabelSectionCrudService.ToEncryptedEntity"] = nameof(LabelControllerDecompositionServiceTests),
            ["LabelSectionCrudService.TryDecryptPk"] = nameof(LabelControllerDecompositionServiceTests),
