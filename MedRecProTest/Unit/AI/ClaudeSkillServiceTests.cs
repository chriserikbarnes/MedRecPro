...
namespace MedRecProTest.Unit.AI
{
    ...
    public class ClaudeSkillServiceTests
    {
        ...
        /// </summary>
        /// <remarks>
        /// The build-time repository marker keeps source lookup independent of output layout.
        /// </remarks>
        ...
        private static string findProjectRoot()
        {
            ...
            var projectRoot = Path.Combine(RepositorySourceRoot.RootPath, "MedRecPro");
            if (File.Exists(Path.Combine(projectRoot, "MedRecPro.csproj")) &&
                Directory.Exists(Path.Combine(projectRoot, "Skills")))
            {
                return projectRoot;
            }

            throw new DirectoryNotFoundException(
                $"The repository marker resolved '{RepositorySourceRoot.RootPath}', but the MedRecPro Skills source was not found at '{projectRoot}'.");
