...
namespace MedRecProTest.Unit.Parsing.OrangeBook
{
    ...
    /// <see cref="OrangeBookModel.PatentUseCodeDefinition"/> records,
    ...
    /// <seealso cref="OrangeBookModel.PatentUseCodeDefinition"/>
    ...
    public class OrangeBookPatentUseCodeParsingServiceTests
    {
        ...
        public async Task ProcessPatentUseCodesAsync_InsertsAllCodes()
        {
            ...
            try
            {
                ...
                // Assert
                var records = await context.Set<OrangeBookModel.PatentUseCodeDefinition>().ToListAsync();
        ...
        public async Task ProcessPatentUseCodesAsync_UpdatesExistingDefinition()
        {
            ...
            try
            {
                ...
                if (connection.State != System.Data.ConnectionState.Open) await connection.OpenAsync();
                var countAfterFirst = await context.Set<OrangeBookModel.PatentUseCodeDefinition>().CountAsync();
                ...
                // Assert
                var countAfterSecond = await context2.Set<OrangeBookModel.PatentUseCodeDefinition>().CountAsync();
