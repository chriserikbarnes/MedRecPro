...
using OrangeBookModel = MedRecProImportClass.Models.OrangeBook;

namespace MedRecProTest.Unit.Parsing.OrangeBook
{
    /**************************************************************/
    /// <summary>
    ...
    /// <seealso cref="OrangeBookModel.Product"/>
    /// <seealso cref="OrangeBookModel.Applicant"/>
    ...
    public class OrangeBookProductParsingServiceTests
    {
        ...
        public async Task ProcessProductsFileAsync_NewProducts_CreatesApplicantsAndProducts()
        {
            ...
            try
            {
                ...
                // Assert
                var applicants = await context.Set<OrangeBookModel.Applicant>().ToListAsync();
                ...
                var products = await context.Set<OrangeBookModel.Product>().ToListAsync();
        ...
        public async Task ProcessProductsFileAsync_ParsesFieldsCorrectly()
        {
            ...
            try
            {
                ...
                // Assert
                var product = await context.Set<OrangeBookModel.Product>().FirstAsync();
        ...
        public async Task ProcessProductsFileAsync_ExistingProduct_UpdatesFields()
        {
            ...
            try
            {
                ...
                // Assert
                var products = await context2.Set<OrangeBookModel.Product>().ToListAsync();
        ...
        public async Task ProcessProductsFileAsync_OrgMatchExact_CreatesJunction()
        {
            ...
            try
            {
                ...
                // Assert
                var junctions = await context.Set<OrangeBookModel.ApplicantOrganization>().ToListAsync();
        ...
        public async Task ProcessProductsFileAsync_IngredientExactMatch_CreatesJunction()
        {
            ...
            try
            {
                ...
                // Assert
                var junctions = await context.Set<OrangeBookModel.ProductIngredientSubstance>().ToListAsync();
                Assert.IsTrue(junctions.Count > 0,
        ...
        public async Task ProcessProductsFileAsync_CategoryExactMatch_CreatesJunction()
        {
            ...
            try
            {
                ...
                // Assert
                var junctions = await context.Set<OrangeBookModel.ProductMarketingCategory>().ToListAsync();
                Assert.IsTrue(junctions.Count > 0,
