...
namespace MedRecProTest.Unit.Parsing.OrangeBook
{
    ...
    /// <seealso cref="OrangeBookModel.Exclusivity"/>
    ...
    public class OrangeBookExclusivityParsingServiceTests
    {
        ...
        /**************************************************************/
        /// <summary>
        /// Seeds an OrangeBookModel.Product record in the test database for FK resolution tests.
        /// </summary>
        ...
        {
            #region implementation
            var product = new OrangeBookModel.Product
            {
                ApplType = applType,
                ApplNo = applNo,
                ProductNo = productNo,
            ...
            context.Set<OrangeBookModel.Product>().Add(product);
        ...
        public async Task ProcessExclusivityFileAsync_NewRecords_InsertsAll()
        {
            ...
            var records = await context.Set<OrangeBookModel.Exclusivity>().ToListAsync();
        ...
        public async Task ProcessExclusivityFileAsync_ExistingRecords_UpdatesDate()
        {
            ...
            // Assert — reopen connection (service closes it in finally block; shared DB survives)
            if (connection.State != System.Data.ConnectionState.Open) await connection.OpenAsync();
            var records = await context2.Set<OrangeBookModel.Exclusivity>().ToListAsync();
        ...
        /**************************************************************/
        /// <summary>
        /// Verifies that exclusivity records are linked to seeded OrangeBookModel.Product
