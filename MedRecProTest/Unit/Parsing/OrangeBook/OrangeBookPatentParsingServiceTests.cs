...
namespace MedRecProTest.Unit.Parsing.OrangeBook
{
    ...
    /// <seealso cref="OrangeBookModel.Patent"/>
    ...
    public class OrangeBookPatentParsingServiceTests
    {
        ...
        /**************************************************************/
        /// <summary>
        /// Seeds an OrangeBookModel.Product record for FK resolution tests.
        /// </summary>
        /// <param name="context">The test database context.</param>
        ...
        public async Task ProcessPatentsFileAsync_NewRecords_InsertsAll()
        {
            ...
            try
            {
                ...
                // Assert
                var records = await context.Set<OrangeBookModel.Patent>().ToListAsync();
        ...
        public async Task ProcessPatentsFileAsync_ExistingRecords_UpdatesFields()
        {
            ...
            try
            {
                ...
                // Assert
                var records = await context2.Set<OrangeBookModel.Patent>().ToListAsync();
